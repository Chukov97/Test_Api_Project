...
class Checking:
    ...
    """Метод для проверки наличия значений обязательных полей в ответе запроса"""
    ...
    """Метод для проверки наличия значений обязательных полей в ответе запроса по заданному слову"""
